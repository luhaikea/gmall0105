...
public class SpuServiceImpl implements SpuService {
    ...
    public List<PmsProductSaleAttr> spuSaleAttrList(String spuId) {
        ...
        for (PmsProductSaleAttr productSaleAttr : PmsProductSaleAttrs) {
            ...
            //一个pmsProductSaleAttrValue可以通过product_id和sale_attr_id确定
    ...
    public void saveSpuInfo(PmsProductInfo pmsProductInfo) {
        ...
        // 保存商品信息
        System.out.println("商品主键1:"+pmsProductInfo.getId());//输出null
        //使用通用mapper的insertSelective插入数据后,实体类初始为null的id主动映射为数据库自增长的id
        pmsProductInfoMapper.insertSelective(pmsProductInfo);

        System.out.println("商品主键2:"+pmsProductInfo.getId());//输出69
        // 生成商品主键
